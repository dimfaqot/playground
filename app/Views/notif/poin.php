...
<?php else: ?>
    ...
    <div class="bg_secondary text-main text-center fs-6 rounded border_main px-2 py-1 mb-2">POIN: <?= angka($total); ?></div>
    <div class="input-group input-group-sm mb-2">
        <span style="font-size: x-small;" class="input-group-text bg_main border_main text_main">Cari Data</span>
        <input style="font-size: x-small;" type="text" class="form-control cari bg_main border border_main text_main" placeholder="....">
    </div>
            ...
            <?php foreach ($data as $k => $i): ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a style="text-decoration: none;" data-id="<?= $i['id']; ?>" class="d-grid btn_detail text-center text_main bg_secondary"><?= $i['poin']; ?>
                        </a>
                    </td>
                    <td><?= $i['disiplin']; ?></td>
                </tr>
