...
<head>
    ...
    <script>
        const message = (status = "200", message) => {
            let html = `<div class="d-flex justify-content-center text-light">
                            <div class="bg-opacity-25 ${(status=="200"?"bg-success border border-success":"bg-danger border border-danger")} px-5 py-1 rounded" style="font-size: x-small;">${message}</div>
                        </div>`;
...
<body class="text-light">
    <div class="div_top text-light"></div>

    <div class="container" style="margin-bottom: 100px;"><?= $this->renderSection('content') ?></div>

    <div class="fixed-bottom message" style="margin-bottom: 90px;z-index:999999"></div>
    <nav class="fixed-bottom">
        <div class="m-auto text-center p-3 border-top" style="background-color: #1b120c;">
